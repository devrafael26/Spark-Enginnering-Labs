...
Nos experimentos realizados, o operador `Range` utilizou 8 splits para todos os volumes testados. Mesmo com o aumento de 5 milhões, 40 milhões e 300 milhões de registros, a quantidade de splits permaneceu a mesma. Portanto, neste ambiente e para esse operador, o aumento do volume de dados não provocou alteração automática no número de splits.
...
== Parsed Logical Plan ==
Range (0, 40000000, step=1, splits=Some(8))

== Parsed Logical Plan ==
Range (0, 300000000, step=1, splits=Some(8))
